...
proc saveChat*(chatId: string, chatType: ChatType, active: bool = true, color: string = "#000000", name: string = "", profile: string = "", joined: int64 = 0) =
